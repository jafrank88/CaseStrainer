...
with open('motion_test_extractor_fix.json', 'r') as f:
    data = json.load(f)
...
print("=" * 80)
print("TESTING POSITION ALIGNMENT AFTER EXTRACTOR FIX")
print("=" * 80)
    ...
    if start is not None and end is not None:
        ...
        if '2024 WL 1232082' in text_at_pos:
            ...
            if 'Doe v. Teachers Council' in cit['extracted_name']:
                ...
                print(f"  ❌ WRONG - Schiller contamination (semicolon fix needed)")
