    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'task_id' in result:
                ...
                check_cmd = f'docker exec casestrainer-redis-prod redis-cli -a caseStrainerRedis123 exists "rq:job:{task_id}"'
                import subprocess
                ...
                if result.stdout.strip() == '1':
                    ...
                    # Check status
                    status_cmd = f'docker exec casestrainer-redis-prod redis-cli -a caseStrainerRedis123 hget "rq:job:{task_id}" status'
