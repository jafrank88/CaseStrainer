...
class UnifiedCacheManager:
        ...
        try:
            ...
            return {
                "redis": {
                    "host": "localhost",
                    "port": 6379,
                    "databases": {"rq_queue": 0, "citation_cache": 1, "url_cache": 2, "session_data": 3},
                },
                "citation_cache": {"ttl": 2592000, "max_size": "100MB", "compression": True},
                "url_cache": {"ttl": 604800, "max_size": "500MB", "compression": True},
                "database_cache": {"file": "data/citations.db", "indexes": True, "vacuum_interval": 86400},
            }
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if self.config["database_cache"]["indexes"]:
                    ...
                    cursor.execute(
                        "CREATE INDEX IF NOT EXISTS idx_extracted_case_name ON citations(extracted_case_name)"
                    )
    ...
    def _set_memory_cache(self, key: str, data: Dict[str, Any]):
        ...
        if len(self.memory_cache) >= self.memory_cache_max_size:
            oldest_key = min(self.memory_cache.keys(), key=lambda k: self.memory_cache[k]["expires"])
            del self.memory_cache[oldest_key]

        self.memory_cache[key] = {"data": data, "expires": datetime.now() + timedelta(seconds=self.memory_cache_ttl)}
    ...
    def set_url_content(self, url: str, content: str) -> bool:
        ...
        try:
            ...
            self.redis_client.setex(redis_key, self.config["url_cache"]["ttl"], compressed_data)
            return True
        except Exception as e:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        stats = {"redis_connected": self.redis_client is not None, "cache_stats": {}, "memory_usage": {}}
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                for row in cursor.fetchall():
                    ...
                    stats["cache_stats"][cache_type] = {"hits": hits, "misses": misses, "hit_rate": f"{hit_rate:.1f}%"}
        except Exception as e:
                ...
                for row in cursor.fetchall():
                    ...
                    if verification_result:
                        try:
                            ...
                            verification_data = {"valid": True, "found": True, "confidence": 0.8, "source": "database"}
                    else:
                        verification_data = {"valid": True, "found": True, "confidence": 0.8, "source": "database"}
                    ...
                    if self._set_in_redis("citation", citation, data, self.config["citation_cache"]["ttl"]):
                        warmed += 1
