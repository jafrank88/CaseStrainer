...
class SyncProcessorCore:
    ...
    @handle_processor_errors(
        "process_enhanced_sync",
        default_return={"citations": [], "clusters": [], "metadata": {"error": "Processing failed"}},
    )
    def process_enhanced_sync(self, text: str, request_id: str, options: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "citations": [],
                "clusters": [],
                "metadata": {"processing_mode": "enhanced_sync", "error": str(e), "request_id": request_id},
            }
