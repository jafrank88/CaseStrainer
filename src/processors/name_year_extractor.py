...
class NameYearExtractor:
        ...
        try:
            ...
            for citation in citations:
                ...
                if (
                    ...
                    and hasattr(citation, "extracted_case_name")
                    and getattr(citation, "extracted_case_name", None)
                ):
                ...
                if self.enhanced_verifier and self.options.get("enable_enhanced_verification", False):
                    try:
                        verification_result = self.enhanced_verifier.verify_citation_enhanced(citation_text, case_name)
                ...
                if not isinstance(citation, dict) and hasattr(citation, "extracted_case_name"):
    ...
    def _is_valid_citation(
        self, citation_text: str, case_name: Optional[str], year: Optional[str], confidence_score: float
    ) -> bool:
