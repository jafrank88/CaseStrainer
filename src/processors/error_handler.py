    ...
    def decorator(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                error_tracker.record_error(
                    e, ErrorContext(operation=operation, additional_context={"component": "processor"}), severity
                )
                if reraise:
...
def safe_execute(
    ...
    **kwargs,
    ...
    try:
        ...
        error_tracker.record_error(
            e, ErrorContext(operation=operation, additional_context={"function": func.__name__}), severity
        )
        return default_return
...
class ProcessorErrorHandler:
    ...
    def handle_extraction_error(
        self, error: Exception, citation_text: str, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
    ...
    def handle_normalization_error(
        self, error: Exception, citation_text: str, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
    ...
    def handle_clustering_error(
        self, error: Exception, citations_count: int, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
