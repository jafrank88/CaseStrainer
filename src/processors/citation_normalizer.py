    ...
    def normalize_citations_local(self, citations: List, text: str) -> List:
        ...
        try:
            ...
            for citation in citations:
                if not isinstance(citation, dict) and hasattr(citation, "citation"):
                ...
                if len(parts) >= 3:
                    ...
                    normalized.append({"citation": citation_text, "normalized": False})
    ...
    def normalize_citation_text(self, citation_text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(parts) >= 3:
                ...
                return {"citation": citation_text, "normalized": False}
        except Exception as e:
