...
from src.citation_types import CitationList
...
class CitationExtractor:
    ...
    def _init_citation_block_patterns(self):
        ...
        self.compiled_citation_block_patterns = [
            re.compile(pattern, re.IGNORECASE) for pattern in self.citation_block_patterns
        ]
