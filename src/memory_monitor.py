...
class MemoryMonitor:
    ...
    def start_monitoring(self):
        ...
        self.logger.info(
            f"Memory monitoring started (threshold: {self.threshold_mb}MB, interval: {self.check_interval}s)"
        )
    ...
    def get_memory_stats(self) -> Dict:
        ...
        return {
            ...
            "growth_percent": (
                ((latest["memory_mb"] - oldest["memory_mb"]) / oldest["memory_mb"]) * 100
                if oldest["memory_mb"] > 0
                else 0
            ),
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if memory_diff > 50:  # More than 50MB increase
                logging.getLogger(__name__).warning(f"Function {func.__name__} used {memory_diff:.1f}MB of memory")
