...
class CitationExporter:
    ...
    def __init__(self, export_dir: Optional[str] = None, use_bluebook: bool = True):
        ...
        logger.info(
            f"CitationExporter initialized with export directory: {self.export_dir}, Bluebook formatting: {use_bluebook}"
        )
    ...
    def export_to_text(
        self, citations: Sequence[Union[CitationResult, Dict[str, Any]]], filename: Optional[str] = None
    ) -> str:
    ...
    def export_to_bibtex(
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            ...
            for i, citation in enumerate(citations, 1):
                ...
                case_name = citation_data.get("extracted_case_name", "Unknown")
    ...
    def export_to_endnote(
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            for citation in citations:
                ...
                case_name = citation_data.get("extracted_case_name", "Unknown Case")
                ...
                f.write(
                    f"AB  - Verified: {citation_data.get('verified', False)}, Confidence: {citation_data.get('confidence', 0.0):.2f}\n"
                )
                f.write("ER  - \n\n")
    ...
    def export_citations(
        self,
        citations: Sequence[Union[CitationResult, Dict[str, Any]]],
        format_type: str,
...
def export_citations_to_format(
    citations: Sequence[Union[CitationResult, Dict[str, Any]]],
    format_type: str,
    filename: Optional[str] = None,
...
def create_citation_report(
    citations: Sequence[Union[CitationResult, Dict[str, Any]]], export_dir: Optional[str] = None
) -> Dict[str, str]:
    """
