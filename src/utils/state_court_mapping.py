...
STATE_REPORTERS = {
    ...
    "S.W.": {
        "states": ["Arkansas", "Kentucky", "Missouri", "Tennessee", "Texas"],
    ...
    "S.E.": {
        "states": ["Georgia", "North Carolina", "South Carolina", "Virginia", "West Virginia"],
        "reporter": "South Eastern Reporter",
    },
    # Hawaii
    ...
    "N.E.": {
        "states": ["Illinois", "Indiana", "Massachusetts", "New York", "Ohio"],
    ...
    "N.W.": {
        "states": ["Iowa", "Michigan", "Minnesota", "Nebraska", "North Dakota", "South Dakota", "Wisconsin"],
        "reporter": "North Western Reporter",
    },
    # Kansas
...
STATE_VERIFICATION_SOURCES = [
    {"name": "CourtListener", "url": "https://www.courtlistener.com", "coverage": "all_states", "reliability": "high"},
    {
        "name": "Google Scholar",
    ...
    {"name": "Casetext", "url": "https://casetext.com", "coverage": "all_states", "reliability": "high"},
    {"name": "CaseMine", "url": "https://www.casemine.com", "coverage": "all_states", "reliability": "medium"},
    {"name": "Justia", "url": "https://law.justia.com", "coverage": "all_states", "reliability": "high"},
    {"name": "FindLaw", "url": "https://caselaw.findlaw.com", "coverage": "all_states", "reliability": "medium"},
]
