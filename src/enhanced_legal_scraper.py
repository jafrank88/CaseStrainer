...
class EnhancedLegalScraper:
    ...
    def __init__(
        self, use_duckduckgo: bool = True, use_google: bool = True, use_bing: bool = True, cache_results: bool = True
    ):
        """
        ...
        self.legal_databases = {
            ...
            "justia": {"domain": "justia.com", "detail_patterns": ["/cases/", "/opinions/"], "name": "Justia"},
            "findlaw": {"domain": "findlaw.com", "detail_patterns": ["/caselaw/", "/opinions/"], "name": "FindLaw"},
            "casetext": {"domain": "casetext.com", "detail_patterns": ["/case/", "/opinion/"], "name": "CaseText"},
            "leagle": {"domain": "leagle.com", "detail_patterns": ["/case/", "/opinion/"], "name": "Leagle"},
            "supreme_court": {
