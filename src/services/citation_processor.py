...
class CitationProcessor(ICitationProcessor):
    ...
    async def process_document_citations(
        self, document_text: str, document_type: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _format_results(
        self, citations: List[CitationResult], clusters: List[Dict[str, Any]], text: str
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "processing_info": {
                ...
                "config": {"use_eyecite": self.config.use_eyecite, "debug_mode": self.config.debug_mode},
            },
        }
    ...
    def _update_stats(
        self, citations: List[CitationResult], clusters: List[Dict[str, Any]], processing_time: float
    ) -> None:
