...
class CitationVerifier:
    ...
    def verify_citations_with_canonical_service(self, citations: CitationList) -> None:
        ...
        logger.warning(
            "[DEPRECATED] verify_citations_with_canonical_service called - use cluster_citations_unified instead"
        )
    ...
    async def verify_citations_with_legal_websearch(self, citations: CitationList) -> None:
        ...
        logger.warning(
            "[DEPRECATED] verify_citations_with_legal_websearch called - use cluster_citations_unified instead"
        )
    ...
    async def verify_citations(self, citations: CitationList, text: Optional[str] = None) -> CitationList:
        ...
        logger.info(
            f"[VERIFY_CITATIONS] Step 3: {len(still_unverified)} still unverified citations after canonical service"
        )
        if still_unverified:
    ...
    def validate_verification_result(self, citation: CitationResult, source: str) -> Dict[str, Any]:
        ...
        validation_result = {"valid": True, "source": source, "issues": []}
