...
class EnhancedLegalSearchEngine:
    ...
    def generate_enhanced_legal_queries(self, citation: str) -> List[Dict[str, Any]]:
        ...
        for variant in variants:
            ...
            for context_query in legal_contexts:
                queries.append({"query": context_query, "priority": 1, "type": "legal_context", "citation": variant})
            legal_sites = [
                "site:justia.com",
            ...
            for broad_query in broad_queries:
                queries.append({"query": broad_query, "priority": 4, "type": "broad_legal", "citation": variant})
        return queries
    ...
    def is_washington_citation(self, citation: str) -> bool:
        ...
        washington_indicators = [r"\bWn\.?\s*\d+d\b", r"\bWash\.?\s*\d+d\b", r"\bWashington\s*\d+d\b"]
