...
class URLDecoder:
        ...
        try:
            ...
            if match:
                ...
                try:
                    ...
                    logger.info(
                        f"Successfully decoded Microsoft Defender URL: {url[:100]}... -> {decoded_url[:100]}..."
                    )
                    return decoded_url
            ...
            for pattern in patterns:
                ...
                if match:
                    ...
                    try:
                        ...
                        decoded_url = urllib.parse.unquote(encoded_url)
                        logger.info(
                            f"Successfully decoded Bing URL (fallback): {url[:100]}... -> {decoded_url[:100]}..."
                        )
                        return decoded_url
            return None
        except Exception as e:
    ...
    def clean_url(url: str) -> str:
        ...
        prefixes_to_remove = ["http://", "https://", "www.", "mailto:"]
