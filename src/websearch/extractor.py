...
class ComprehensiveWebExtractor:
    ...
    def _extract_title(self, soup) -> str:
        ...
        title_selectors = ["title", "h1", ".title", ".case-title", ".document-title", '[class*="title"]']
    ...
    def _extract_case_name(self, soup, citation: str) -> str:
        ...
        case_name_selectors = [".case-name", ".title", "h1", '[class*="case"]', '[class*="name"]']
    ...
    def _extract_court_info(self, soup) -> str:
        ...
        court_selectors = [".court", ".jurisdiction", '[class*="court"]', '[class*="jurisdiction"]']
    ...
    def _extract_date_info(self, soup) -> str:
        ...
        date_selectors = [".date", ".decision-date", '[class*="date"]', "time"]
    ...
    def _extract_content(self, soup) -> str:
        ...
        content_selectors = [".content", ".main-content", ".document-content", "article", "main", '[class*="content"]']
    ...
    def _extract_casemine_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "casemine"}
    ...
    def _extract_vlex_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "vlex"}
    ...
    def _extract_casetext_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "casetext"}
    ...
    def _extract_leagle_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "leagle"}
    ...
    def _extract_justia_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "justia"}
    ...
    def _extract_findlaw_info(self, html_content: str, url: str) -> Dict[str, Any]:
        ...
        return {"title": title, "case_name": case_name, "court": court, "date": date, "url": url, "source": "findlaw"}
