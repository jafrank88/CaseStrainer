...
class ComprehensiveWebSearchEngine:
        ...
        try:
            ...
            if results:
                ...
                for result in results:
                    ...
                    if "law.resource.org" in url and any(
                ...
                if legal_results:
                    ...
                    return {"source": "law_resource", "verified": True, "results": legal_results}
    ...
    async def search_multiple_sources(
        self, citation: str, case_name: Optional[str] = None, max_concurrent: int = 3
    ) -> Dict:
    ...
    async def search_cluster_canonical(self, cluster: Dict, max_results: int = 10) -> List[Dict]:
        ...
        for query_info in queries[:8]:  # Increased from 5 to 8 to get more citation-based queries
            ...
            recommended_sources = self.source_predictor.predict_best_sources(
                query_info.get("citation", ""), query_info.get("case_name", "")
            )
    ...
    def _update_stats(self, method: str, success: bool, duration: float):
        ...
        self.stats["average_response_time"] = (current_avg * (total_searches - 1) + duration) / total_searches
