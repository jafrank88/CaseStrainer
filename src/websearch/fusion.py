...
class ResultFusionEngine:
    ...
    def fuse_results(
        self, results: List[Dict], query_citation: str, query_case_name: Optional[str] = None
    ) -> List[Dict]:
    ...
    def _fuse_result_group(
        self, group: List[Dict], query_citation: str, query_case_name: Optional[str] = None
    ) -> Optional[Dict]:
    ...
    def _calculate_reliability_score(
        self, result: Dict, query_citation: str, query_case_name: Optional[str] = None
    ) -> float:
