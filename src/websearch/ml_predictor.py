...
class AdvancedMLPredictor:
    ...
    def __init__(self, cache_manager: CacheManager):
        ...
        self.success_rates = {
            ...
            "federal_supreme": {"justia": 0.90, "findlaw": 0.85, "google_scholar": 0.80, "courtlistener_web": 0.95},
            "federal_circuit": {"justia": 0.80, "findlaw": 0.75, "leagle": 0.85, "casetext": 0.80},
        }
    ...
    def _extract_reporter_type(self, citation: str) -> str:
        ...
        reporters = {"Wn.": "washington", "Wash.": "washington", "U.S.": "supreme", "F.": "federal", "P.": "pacific"}
