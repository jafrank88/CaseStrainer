...
def validate_single_citation():
    ...
    try:
        ...
        if citations:
            ...
            try:
                validation_status = loop.run_until_complete(processor._verify_citations([citation]))
...
def extract_citations():
    ...
    try:
        ...
        return jsonify({"success": True, "citations": citation_data, "count": len(citation_data)})
