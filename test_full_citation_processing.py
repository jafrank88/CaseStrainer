#!/usr/bin/env python3
"""
Test full citation processing to debug the stuck at 20% issue
"""
...
def main():
    ...
    print("=== Testing Full Citation Processing ===")
    ...
    try:
        ...
        print("Starting full citation processing...")
        start_time = time.time()
        
        # This is what the API calls after text extraction
        result = service.process_citations(input_data)
