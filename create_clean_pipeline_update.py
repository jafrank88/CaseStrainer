"""
Update clean_extraction_pipeline.py to use extract_citations_unified
"""

print("UPDATING clean_extraction_pipeline.py")
print("=" * 60)

print("\nCreating a wrapper that uses the new unified function...")

# Create the updated extract_citations_clean function
updated_function = '''
...
print("\nUpdated function created. Now updating clean_extraction_pipeline.py...")

with open('D:/dev/casestrainer/update_clean_pipeline.py', 'w') as f:
    f.write(updated_function)

print("\n" + "=" * 60)
print("NEXT STEPS:")
print("1. The extract_citations_unified function is working")
print("2. Need to update clean_extraction_pipeline.py to use it")
print("3. Add deprecation warnings to guide migration")
print("4. Test that all existing functionality still works")
print("=" * 60)
